...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!project) {
    return {
      title: "Projet introuvable | Hugo Leray — Développeur Web",
    };
  }

  const title = `${project.nom} | Hugo Leray — Développeur Web`;
  const description =
    project.type === "dev"
      ? `${project.description} Technologies : ${project.technologies.join(", ")}. Projet réalisé en ${project.annee} par Hugo Leray, développeur web indépendant.`
      : `${project.description} Création graphique réalisée en ${project.annee} par Hugo Leray. Outils : ${project.technologies.join(", ")}.`;

  return {
    title: {
      absolute: `${project.nom} | Hugo Leray — Développeur Web`,
    },
    description,
    alternates: {
      canonical: `/galerie/${project.id}`,
    },
    openGraph: {
      type: "website",
      locale: "fr_FR",
      url: `https://portfolio2025.netlify.app/galerie/${project.id}`,
      title,
      description,
      images: project.imgGallery[0] ? [{ url: project.imgGallery[0] }] : undefined,
    },
  };
}
          ...
          <div className="flex flex-col justify-center items-center px-4 sm:px-8 md:px-12 lg:px-[68px] py-16">
            ...
            <div className="relative text-center mb-8 w-full">
              ...
              <Image
                ...
                alt={`${project.nom} — création graphique de Hugo Leray`}
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center gap-4 mb-6">
                  ...
                  <div className="text-primary/60 text-lg">{project.annee}</div>
                </div>
                ...
                <div className="mb-8">
                  <h4 className="text-primary font-semibold mb-3 uppercase tracking-wide">
                    Outils utilisés :
                  </h4>
          ...
          <div className="flex w-full flex-col lg:flex-row min-h-[50vh] items-center px-4 sm:px-8 md:px-12 lg:px-[68px] py-16">
            ...
            <div className="flex-1 flex flex-col justify-center lg:pr-12 mb-8 lg:mb-0">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="text-primary/60 text-sm">{project.annee}</div>
              </div>
