...
export const Projects : ProjectList[] = [
    ...
    },
    {
        ...
        type: "graph",
        imgLeft: "/img/dieux/Artémis.png",
        imgRight: "/img/dieux/Hermès.png",
        imgUp: "/img/dieux/Zeus.png",
        imgGallery: ["/img/dieux/Zeus.png", "/img/dieux/Artémis.png", "/img/dieux/Hermès.png", "/img/dieux/Athéna.png", "/img/dieux/Poséidon.png", "/img/dieux/Arès.png"],
    ...
    },
    {
        ...
        type: "dev",
        imgLeft: "/img/cocktail/produit.png",
        imgRight: "/img/cocktail/produit2.png",
        imgUp: "/img/cocktail/heropng.png",
        imgGallery: ["/img/cocktail/heropng.png", "/img/cocktail/pageproduit.png", "/img/cocktail/produit.png", "/img/cocktail/produit2.png"],
